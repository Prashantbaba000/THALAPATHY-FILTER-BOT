...
URL = "https://autofilterstream-7avg.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilterstream-7avg.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilterstream-7avg.onrender.com/".format(FQDN)
else:
    URL = "https://autofilterstream-7avg.onrender.com/".format(FQDN)
